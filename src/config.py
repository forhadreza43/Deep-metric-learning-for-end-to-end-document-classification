...
class Paths:
    project_root: Path
    qs_ocr_large_dir: Path        # Project/QS-OCR-Large
...
class TrainConfig:
    ...
    seed: int = 42
    num_workers: int = 0                   # Windows/PyCharm friendly
    debug_samples: int = 128               # GPU run: None
    device: str = "cpu"                    # GPU run: switch to "cuda" later
